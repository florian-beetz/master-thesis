...
\draw[fill=black!5!white] (srv2.north west) -- ++(0.25,0.25) -- ($(srv2.north east)+(0.25,0.25)$) -- (srv2.north east);
\draw[fill=black!10!white] (srv2.north east) -- ++(0.25,0.25) -- ($(srv2.south east)+(0.25,0.25)$) -- (srv2.south east);

\node[server, fit=(proc3)] (srv3) {};
\draw[fill=black!5!white] (srv3.north west) -- ++(0.25,0.25) -- ($(srv3.north east)+(0.25,0.25)$) -- (srv3.north east);
\draw[fill=black!10!white] (srv3.north east) -- ++(0.25,0.25) -- ($(srv3.south east)+(0.25,0.25)$) -- (srv3.south east);

\node[server, fit=(proc4)] (srv4) {};
\draw[fill=black!5!white] (srv4.north west) -- ++(0.25,0.25) -- ($(srv4.north east)+(0.25,0.25)$) -- (srv4.north east);
\draw[fill=black!10!white] (srv4.north east) -- ++(0.25,0.25) -- ($(srv4.south east)+(0.25,0.25)$) -- (srv4.south east);

\node[server, fit=(db3)] (srv5) {};
\draw[fill=black!5!white] (srv5.north west) -- ++(0.25,0.25) -- ($(srv5.north east)+(0.25,0.25)$) -- (srv5.north east);
\draw[fill=black!10!white] (srv5.north east) -- ++(0.25,0.25) -- ($(srv5.south east)+(0.25,0.25)$) -- (srv5.south east);
