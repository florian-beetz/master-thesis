...
%
% Titlepage
\maketitle{Masterarbeit|Bachelorarbeit}{Wirtschaftsinformatik|Angewandte Informatik|International Software Systems Science}{Thesis Topic}{Author}{dd.mm.yyyy}
%
% TOCs
\pagenumbering{Roman}
\tableofcontents
...
\makedeclaration{Masterarbeit|Bachelorarbeit}{16.11.2012}{Alan Turing}
%
\end{document}
