...
\begin{lstlisting}[caption={Enumeration Types and Arguments on GraphQL Fields}, language=graphqls]
enum LengthUnit {
    METER
    FEET
}
...
\begin{lstlisting}[caption={Interfaces in GraphQL Schemas}, language=graphqls]
...
\begin{lstlisting}[caption={Union Types in GraphQL}, language=graphqls]
...
\begin{lstlisting}[caption={Input Types}, language=graphqls]
input VehicleInput {
    vehicleType: String!
    ownerId: ID!
}
