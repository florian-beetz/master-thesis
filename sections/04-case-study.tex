...
\begin{lstlisting}[caption={Response to \texttt{GET} requests for updatable resources}, showlines=true, label=lst:traefik-docker, language=yaml]
labels:
  - "traefik.enable=true"
...
\begin{lstlisting}[caption={Data fetching in API models}, language=java]
public class Item {
...
\begin{lstlisting}[caption={API model creation with fetcher injection}, language=java]
