...
A response to this endpoint is shown in \autoref{lst:response-stock-col}.
This response

\begin{lstlisting}[caption={Response to Fetching the Stock Position Collection}, language=json, label={lst:response-stock-col}]
{ "_embedded": { "itemStockList": [
  {
    "inStock": 187,
    "available": 65,
    [...]
  ...
  "_links": {
    "self": { "href": "[...]/api/v1/item/2/stock/?page=0&size=20" }, 
    "first": { "href": "[...]/api/v1/item/2/stock/?page=0&size=20" },
    "next": { "href": "[...]/api/v1/item/2/stock/?page=1&size=20" },
    "last": { "href": "[...]/api/v1/item/2/stock/?page=2&size=20" }
  }
}
\end{lstlisting}
