...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Experienced Response Time by Users}\label{fig:exp-resp-time}    
\end{figure}
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
          ...
          \addlegendentry{GraphQL}
          \addplot[mark=none, theme1!50!white, dashed] coordinates {(0,56.4) (450,56.4)};
          \addplot[mark=none, theme2!50!white, dashed] coordinates {(0,5.46) (450,5.46)};
        \end{axis}
    \end{tikzpicture}
    \caption{Response Time of the Order Service}\label{fig:order-resp-time}    
\end{figure}
